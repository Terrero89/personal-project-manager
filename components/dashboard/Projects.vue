...
<template>
  <div class="dashboard-item d-flex justify-content-center">
    <div class="info-section">
      <div class="dashboard-info m-3">
        ...
        <div class="item d-flex justify-content-between">
          ...
          <span class="digit text-primary fw-bold"> {{ inProgressAvg }}%</span>
        </div>
        ...
        <div class="item d-flex justify-content-between">
          ...
          <span class="digit fw-bold badge rounded-pill bg-info text-dark px-2"
            >{{ averageDays }} Days
          </span>
        </div>
      </div>
